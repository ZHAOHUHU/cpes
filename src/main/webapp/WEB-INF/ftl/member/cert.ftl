              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="${APP_PATH}/logout.htm">退出系统</a></li>
                  </ul>
                </li>
              </ul>
            </div>
...
<hr>
	...
	<script>
		...
		$("#applyBtn").click(function(){
		    if ( acctype == "" ) {
				layer.msg("请选择账户类型", {time:2000, icon:5});
				return;
		    }
		    
		    window.location.href = "${APP_PATH}/member/apply-1.htm?acctype=" + acctype;
		});
		
		$("a[data-acctype]").click(function(){
