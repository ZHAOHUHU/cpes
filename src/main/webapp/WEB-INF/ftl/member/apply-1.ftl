 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" action="${APP_PATH}/member/doapply1.do" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="frealname">真实名称</label>
			<input type="text" class="form-control" name="realname" id="frealname" placeholder="真实名称">
		  </div>
		  <div class="form-group">
			<label for="cardno">身份证号码</label>
			<input type="text" class="form-control" id="fcardno" name="cardno" placeholder="身份证号码">
		  </div>
