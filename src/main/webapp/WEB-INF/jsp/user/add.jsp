        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="userForm" role="form" action="${APP_PATH}/user/insert.do" method="post">
				  <div class="form-group">
					<label for="exampleInputPassword1">登陆账号</label>
					<input type="text" class="form-control" id="floginacct" name="loginacct" placeholder="登陆账号">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="fusername" name="username" placeholder="用户名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="text" class="form-control" id="femail" name="email" placeholder="Enter email">
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	*/
			    	$("#userForm").ajaxSubmit({
			    		...
			    		success : function(r) {
			    			if ( r.success ) {
				    			layer.confirm("用户信息保存成功,是否连续输入",  {icon: 3, title:'提示'}, function(cindex){
				    				layer.close(cindex);
				    			}, function(cindex){
					    		...
					    		layer.msg("用户信息保存失败", {time:2000, icon:5, shift:6});
			    			}
			    		}
			    	});
