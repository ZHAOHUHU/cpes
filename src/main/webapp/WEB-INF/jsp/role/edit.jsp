        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="roleForm" role="form" action="${APP_PATH}/role/update.do" method="post">
				  <input type="hidden" name="id" value="${role.id}">
				  <div class="form-group">
					<label for="exampleInputPassword1">角色名称</label>
					<input type="text" class="form-control" id="fname" name="name" value="${role.name}" placeholder="角色名称">
				  </div>
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	*/
			    	$("#roleForm").ajaxSubmit({
			    		...
			    		success : function(r) {
			    			if ( r.success ) {
			    				layer.msg("角色信息修改成功", {time:2000, icon:6});
			    			} else {
					    		layer.msg("角色信息修改失败", {time:2000, icon:5, shift:6});
			    			}
			    		}
			    	});
